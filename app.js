document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = (date) => {
    ...
    const result = ` <span class="digit">${days}</span> days <span class="digit">${hours}</span> hours <span class="digit">${minutes}</span> mins <span class="digit">${seconds}</span> seconds`;
